...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jaraco.context-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15587&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jaraco.context-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jaraco.context` can be installed with:

```
conda install jaraco.context
```

It is possible to list all of the versions of `jaraco.context` available on your platform with:
